...
export default function HomePage() {
  ...
  const videos = [
    ...
    },
    {
      ...
      description: "นายจ้างสามารถค้นหาผู้สมัครที่มีทักษะและความสามารถตรงตามความต้องการของงาน",
    },
    {
      id: 3,
      src: "/หน้าหลัก/3.mp4",
      title: "การสร้างเครือข่ายมืออาชีพ",
      description: "หาโอกาสในการแสดงความสามารถพิเศษของคุณให้นายจ้างเห็น นอกเหนือจากการสมัครงานแบบเดิมๆ",
    },
  ]
  ...
  const slides = [
    ...
    },
    {
      ...
      description:
        "ทุก Skillbridge มาพร้อมเรซูเม่คุณภาพสูงที่สถาบันจัดเตรียมให้ เราดูแลตั้งแต่การออกแบบไปจนถึงการปรับแต่งเพื่อให้ครบถ้วนสมบูรณ์ รองรับการอ่านโดยระบบอัตโนมัติ และสามารถอัปเดตได้ตลอดเวลา เพื่อให้ทันกับความก้าวหน้าในด้านการศึกษาและอาชีพ พร้อมสร้างความประทับใจให้นายจ้าง",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16 md:pb-20">
              <div className="grid lg:grid-cols-2 gap-16 md:gap-24 items-center min-h-[70vh] md:min-h-[80vh]">
                ...
                <div className="text-center lg:text-left space-y-8">
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight md:leading-tight lg:leading-tight mb-8 font-kanit tracking-tighter">
                    สร้างอาชีพด้วย
                  ...
                  <p className="max-w-md mx-auto lg:mx-0 text-lg md:text-xl text-muted-foreground">
                    โปรแกรมรับรองคุณวุฒิช่วยเตรียมผู้เรียนและผู้เชี่ยวชาญเข้าสู่ตลาดแรงงานได้อย่างมั่นใจ Skillbridge พร้อมช่วยให้คุณโดดเด่นและก้าวสู่โอกาสใหม่ ๆ
                  </p>
          ...
          <div className="relative max-w-6xl mx-auto z-10">
            <div className="text-center mb-16">
              <h2 className="text-5xl font-bold bg-gradient-to-r from-foreground via-primary to-foreground bg-clip-text text-transparent mb-10 relative z-10"
                  style={{ 
                    fontFamily: "'TH Sarabun PSK', 'Noto Sans Thai', 'Sukhumvit', sans-serif", 
                    fontSize: '2.5rem', 
                    lineHeight: 1.8, 
                    letterSpacing: 0,
            ...
            <div className="grid md:grid-cols-3 gap-10 relative z-10">
              <Card className="border-0 shadow-xl bg-gradient-to-br from-card/95 to-card/50 backdrop-blur-sm z-10">
                <CardHeader className="text-center">
                  <div className="w-20 h-20 bg-gradient-to-br from-primary/10 to-primary/10 rounded-2xl flex items-center justify-center mb-6 mx-auto">
                    <Award className="w-10 h-10 text-primary" />
                  </div>
                  <CardTitle className="text-2xl">ประสบการณ์ที่ครอบคลุม</CardTitle>
                  <CardDescription className="text-base leading-relaxed">
                    รวบรวมเอกสารทุกโปรเจกต์ บทบาท และความสำเร็จ พร้อมรายละเอียดและบริบทที่สำคัญครบถ้วน
                  </CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card className="border-0 shadow-xl bg-gradient-to-br from-card/95 to-card/50 backdrop-blur-sm z-10">
                <CardHeader className="text-center">
                  <div className="w-20 h-20 bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl flex items-center justify-center mb-6 mx-auto">
                    <Search className="w-10 h-10 text-primary" />
                  </div>
                  <CardTitle className="text-2xl">การค้นหาขั้นสูง</CardTitle>
                  <CardDescription className="text-base leading-relaxed">
                    นายจ้างสามารถหาผู้สมัครที่มีทักษะเฉพาะและคุณสมบัติที่หาได้ยาก
                  </CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card className="border-0 shadow-xl bg-gradient-to-br from-card/95 to-card/50 backdrop-blur-sm z-10">
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="text-2xl">เครือข่ายมืออาชีพ</CardTitle>
                  <CardDescription className="text-base leading-relaxed">
                    หาโอกาสในการแสดงความสามารถพิเศษของคุณให้นายจ้างเห็น นอกเหนือจากการสมัครงานแบบเดิมๆ
                  </CardDescription>
                </CardHeader>
              </Card>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-12 items-start">
              ...
              <div className="space-y-6">
                <div className="text-center lg:text-left">
                  <h2 className="text-3xl font-bold text-foreground mb-4">การใช้งาน Skillbridge ในการทำงาน</h2>
                  <p className="text-muted-foreground">
                    ดูว่าแพลตฟอร์มของเราช่วยให้การแชร์และยืนยันข้อมูลประจำตัวง่ายและน่าเชื่อถือได้อย่างไร
                  </p>
                </div>
                ...
                >
                  <div className="space-y-6">
                    <h2 className="text-4xl lg:text-5xl font-bold text-primary-foreground leading-tight">
                      เรซูเม่ไม่มีการพัฒนามาเวลานาน
                    </h2>
                    <p className="text-xl text-white leading-relaxed">
                      ตลอดหลายปีที่ผ่านมา เรซูเม่ไม่มีการพัฒนา ทำให้ข้อมูลบนเรซูเม่กระดาษไม่เพียงพอสำหรับโลกดิจิทัล นายจ้างจึงขาดเครื่องมือสำคัญในการค้นหา คัดสรร
                      และจ้างพนักงานที่มีศักยภาพสูงสุดเพื่อขับเคลื่อนองค์กรให้เติบโต
                    </p>
                    <div className="text-center py-8">
                      <h3 className="text-3xl font-bold text-primary-foreground">...แต่ตอนนี้ทุกอย่างกำลังจะเปลี่ยนไป!</h3>
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-4xl lg:text-5xl font-bold text-foreground mb-6">
                ปลดล็อกศักยภาพด้วยข้อมูลประจำตัวดิจิทัล
              </h2>
              <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                Skillbridge มอบข้อมูลประจำตัวดิจิทัลที่ยืนยันได้ให้กับผู้หางาน เพื่อใช้แสดงทักษะ ความสามารถ และข้อมูลที่เชื่อถือได้ต่อนายจ้าง
              </p>
            </div>
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <p className="text-lg text-muted-foreground font-dm-sans leading-relaxed">
                        {[
                          "ด้วย skillbridge สถาบันสามารถรับรองบุคคลได้อย่างมั่นใจ ข้อมูลประจำตัวดิจิทัลที่ได้รับการรับรองด้วยบล็อกเชนช่วยให้ผู้หางานสามารถพกพาวุฒิการศึกษา ใบรับรอง และข้อมูลประจำตัวอื่น ๆ ไปได้ตลอดชีวิต ทั้งยังช่วยลดความเสี่ยงจากการปลอมแปลงเอกสาร และเปิดโอกาสให้นายจ้างตรวจสอบข้อมูลสำคัญได้ทันทีแบบเรียลไทม์",
